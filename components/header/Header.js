	...
	return (
		<>
			<header className={styles.header}>
				...
				{
					user
						? <UserPicture user={user} onClick={handleToggleOverview} />
						: userLoading
							? <Loading size="small" />
				...
				element={
					<div className={styles.overviewContent}>
						<div className={styles.overviewName}>
							<UserPicture height={40} width={40} user={user} />
						...
						<div className={styles.overviewActionButtons}>
							<Button onClick={handleSignOut} color="purple" sx={buttonStyles}>Sign Out</Button>
						</div>
					</div>
				}
			/>
